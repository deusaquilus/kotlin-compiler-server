...
dependencies {
    ...
    kotlinDependency(libs.decomat)
    kotlinDependency(libs.kotlinx.serialization.json.jvm)
    kotlinDependency(libs.kotlinx.serialization.core.jvm)
    kotlinDependency(libs.kotlinx.serialization.protobuf.jvm)
    kotlinCompilerPluginDependency(libs.kotlinx.serialization.core.jvm)
    kotlinCompilerPluginDependency(libs.kotlin.serialization.plugin)
    kotlinCompilerPluginDependency(libs.kotlinx.serialization.protobuf.jvm)
    kotlinDependency(libs.kotlin.exoquery.runtime)
    kotlinCompilerPluginDependency(libs.kotlin.exoquery.plugin)
    kotlinCompilerPluginDependency(libs.kotlin.exoquery.runtime)
    kotlinCompilerPluginDependency(libs.decomat)
    kotlinCompilerPluginDependency(libs.kotlin.serialization.datetime)
    kotlinCompilerPluginDependency(libs.sqlformatter)
    kotlinCompilerPluginDependency(libs.terpal.runtime)
    kotlinCompilerPluginDependency(libs.pprint.kotlin.core)
    kotlinCompilerPluginDependency(libs.pprint.kotlin.kmp)
    kotlinCompilerPluginDependency(libs.pprint.kotlin.java)
